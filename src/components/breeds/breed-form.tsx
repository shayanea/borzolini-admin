			...
			<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
				...
				<div className='border p-4 rounded-lg bg-gray-50'>
					...
					<div className='flex gap-2 items-center'>
						<Form.Item className='mb-0 flex-1' label='Min' labelCol={{ span: 24 }}>
							<InputNumber
								value={form.formData.average_vitals?.weight_lbs?.min}
								onChange={val => form.handleAverageVitalsChange('weight_lbs', 'min', val || 0)}
								step={0.01}
								className='w-full'
							/>
						</Form.Item>
						...
						<Form.Item className='mb-0 flex-1' label='Max' labelCol={{ span: 24 }}>
							<InputNumber
								value={form.formData.average_vitals?.weight_lbs?.max}
								onChange={val => form.handleAverageVitalsChange('weight_lbs', 'max', val || 0)}
								step={0.01}
								className='w-full'
							/>
						</Form.Item>
