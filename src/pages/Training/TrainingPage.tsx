...
import { ExclamationCircleOutlined, ExperimentOutlined, FilterOutlined } from '@ant-design/icons';
...
import { useTraining, useTrainingForm } from '@/hooks/useTraining';
...
const TrainingPage: React.FC = () => {
  ...
  const loadActivities = async () => {
    ...
    if (activeTab === 'activities') {
      result = await getTrainingActivities(
        params.page!,
        params.limit!,
        params.q,
        params.species,
    ...
    } else if (activeTab === 'search' && searchTerm) {
      result = await searchTrainingActivities(
        searchTerm,
        params.species,
        params.tags,
        params.difficulty,
